...
// Teachers auto-join their own room; the admin console joins a global `admin` room
// (for unread badges) and joins individual teacher rooms on demand when opening a conversation.
io.use((socket, next) => {
